...
funcao_idioma () {
 echo -e " "
msg -bar2
cowsay -f eyes "BIENVENIDO Y GRACIAS POR UTILIZAR NEW-ADM OFICIAL BY JUAN" | lolcat
figlet .×.×.JUAN.×.×. | lolcat
 echo -e " "
msg -bar2
...
msg -bar2
msg -ama "[ NEW - ULTIMATE - SCRIPT ] ➣ \033[1;33m[\033[1;34m OFICIAL BY-JUAN \033[1;33m]"
[[ $1 = "" ]] && funcao_idioma || {
